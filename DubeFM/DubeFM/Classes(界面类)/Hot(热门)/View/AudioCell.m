...
- (void)layoutSubviews{
    ...
    //音频标题
    self.audioTitleLabel.frame = CGRectMake(90, 5, kWW - 100, 35);
    self.audioTitleLabel.font = [UIFont boldSystemFontOfSize:13];
    self.audioTitleLabel.numberOfLines = 0;
    
    //音频作者
    self.authorLabel.frame = CGRectMake(90, 45, kWW / 4 * 3 , 12);
    ...
    //时长
    self.durationLabel.frame = CGRectMake(90, 67, kWW - 90, 12);
